...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.mvpexample=");
    idx += (13 + "mvpexample".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/mvpexample/_sourcemap.json 
//# sourceURL=mvpexample-0.js
